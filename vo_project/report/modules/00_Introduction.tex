...
can be adjusted in the \emph{Configuration Section} and are summarized in Table \ref{table:params}. 
...
Once the pipeline is running an overview detailing the various operation parameters can be seen. 
