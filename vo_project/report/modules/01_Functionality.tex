...
As subsequent frames are processed in a Markovian fashion, meaning that information from the previous frame is sufficient to compute all necessary variables of the subsequent frame \coderef{processFrame.m}. \par
...
Next, new landmarks are triangulated from candidate key points which have been tracked over several frames. 
...
To achieve a more robust behavior, the \emph{Harris score} is suppressed around existing key points before feature extraction \coderef{suppressExistingMatches.m}.